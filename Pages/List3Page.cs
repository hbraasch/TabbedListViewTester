...
{
    public class List3Page : ContentPage
    {

        public List3Page(StartupPageModel viewModel)
        {
            ...
            listView.SetBinding(ListView.ItemsSourceProperty, new Binding(nameof(StartupPageModel.List3DisplayItems), BindingMode.OneWay));
            #endregion
